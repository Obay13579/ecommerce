...
<!--                            -->
                    ...
                    <div class="order-col">
                        ...
                        <div ><strong class="order-total" id="totalCost">{{Session::get('price')}} IDR</strong></div>
                    </div>
                    @else
                    <div class="order-col">
...
<script>
   ...
   //TO DO: ajax will take place
    ...
    $.ajax({
            ...
            {
                document.getElementById("individualPrice_"+order_serial).innerHTML=x*product_price+" IDR";
                document.getElementById("totalCost").innerHTML = msg[2]+" IDR";
            }
            });
